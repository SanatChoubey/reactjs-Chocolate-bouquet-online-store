...
<CardContent>
  ...
  <img alt =""className = "img"src={"https://images.pexels.com/photos/704988/pexels-photo-704988.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"}/>
...
<div><input className="inputs" onChange={(e)=>{this.setState({name:e.target.value })}}type='text'/></div>
...
<Typography variant="h3" color="textSecondary" gutterBottom>
  write a note if you are going to gift  this product to someone
</Typography>
...
<h4> Note: product delivered with 7 days </h4>
...
{sv}
  ...
  return(<div className='progress'>
      ...
      render(){
if(this.state.raz){
  return<div className= 'card'> Thank you for shopping with us You can contact us for order on mobile no - 9770003301</div>
}
